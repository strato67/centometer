...
import { StockContext, StockContextType } from "@/app/dashboard/watchlist/page";
            ...
            <div className="flex items-center mr-6 -mb-4">
                <div className="flex flex-col">
                    <CardHeader>
                        ...
                        <CardDescription>Add up to 6 stocks from your watchlist to follow</CardDescription>
                    </CardHeader>
